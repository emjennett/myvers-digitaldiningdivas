...
public class CreateUserInteractor implements CreateUserInputBoundary {
    ...
    public CreateUserResponseModel create(CreateUserRequestModel model) {
        ...
        User newUser = factory.createUser(model.getUsername(), model.getPassword(), model.getType(), model.getDate());
        CreateUserGatewayModel userDataModel = new CreateUserGatewayModel(newUser.getUserName(), newUser.getPassword(), newUser.getType(), newUser.getDate());
