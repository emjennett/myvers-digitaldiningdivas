...
public class FlaggedReview implements Serializable {
     ...
     *
     * flagged: The review which needs addressing.
     * flagger: Account which flagged the review for review.
     * createdOn: Date which the review was flagged.
     */
    ...
    public Account getFlagger() {
        /**
         * Returns the user who flagged the review.
         */
        return flagger;
    }
